...
driver = webdriver.Chrome(r"C:\Users\Icon\Desktop\TE-Sem2\Internship_project\Auto_testing\chromedriver.exe")
...
try:
    ...
    time.sleep(3)
    driver.find_element_by_name('Name').send_keys('Pratiksha')
    time.sleep(3)
    driver.find_element_by_name('Email').send_keys('gorepratiksha2001@gmail.com')
    time.sleep(3)
